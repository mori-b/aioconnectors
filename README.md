...
-On server side, under "certificates" directory, replace /server/server-cert/server.pem and server.key with your signed certificates. Note that the pem file should contain the whole chain of .crt including the intermediate certificates.
