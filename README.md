...
When server\_ca is false on server side (default), the client certificates are checked against the stored certificates, otherwise against the server CA.
